...
c = [0.000162774133682251, 0.0025004491806030274,
     0.005101539611816406, 0.0022121269702911375]
...
plt.xticks(a, labels)
abar = plt.bar(a - barwidth * 0.6 + 0.01, b, width=barwidth, label='forward')
cbar = plt.bar(a + barwidth * 0.6 - 0.01, c, width=barwidth, label='backward')
autolabel(abar, text='')
autolabel(cbar, text='')
# plt.xlim(-1, 9)
# plt.ylim(-0.5, 4)
