```
richard@anbai~/dev/cuda_misc/nvcc_constexpr_dim3> loadcuda 11.3
...
richard@anbai~/dev/cuda_misc/nvcc_constexpr_dim3> nvcc -std=c++11 -o test test.cu -run
...
```
```
richard@anbai~/dev/cuda_misc/nvcc_constexpr_dim3> loadcuda 11.2
